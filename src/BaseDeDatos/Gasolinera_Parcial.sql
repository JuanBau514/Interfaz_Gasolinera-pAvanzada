...
--
-- Servidor: localhost
-- Tiempo de generación: 11-05-2023 a las 22:18:54
...
(2, 'Gasolina Diesel', 12764, 497, 2),
(3, 'Gasolina Corriente', 12764, 500, 3);
...
--
ALTER TABLE `Productos`
  MODIFY `id_Productos` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
