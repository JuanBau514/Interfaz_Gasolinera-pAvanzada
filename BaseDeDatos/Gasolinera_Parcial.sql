...
--
-- Servidor: localhost
-- Tiempo de generación: 12-05-2023 a las 18:02:27
...
CREATE TABLE `Productos` (
  ...
  `AgregarProducto` tinyint(1) NOT NULL,
  `Fk_Consolidado` int(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
...
INSERT INTO `Productos` (`id_Productos`, `Nombre_Producto`, `Precio_Unitario`, `Cantidad_Disponible`, `AgregarProducto`, `Fk_Consolidado`) VALUES
(4, 'Gasolina Premium', 20000, 500, 1, 1),
(5, 'Gasolina Corriente', 12764, 500, 1, 1);
...
(2, 2, 3, '1:41', '05/12/2022', 'Tanqueo Gasolina', 6),
(3, 2, 2, '6:39', '05/10/2023', 'Tanqueo Gasolina', 2);
...
--
ALTER TABLE `Productos`
  MODIFY `id_Productos` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `Productos`
  ADD CONSTRAINT `Productos_ibfk_1` FOREIGN KEY (`Fk_Consolidado`) REFERENCES `Ventas` (`id_Ventas`) ON DELETE CASCADE ON UPDATE CASCADE;
